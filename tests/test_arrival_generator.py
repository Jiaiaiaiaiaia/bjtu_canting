...
from canteen.simulation.arrival_generator import ArrivalGenerator
from canteen.simulation.student_trace import StudentTrace
...
def test_arrival_generator_replays_precomputed_student_traces(monkeypatch):
    import canteen.simulation.student as student_mod
